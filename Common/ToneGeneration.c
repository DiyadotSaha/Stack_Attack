...
#define TONEDUTY_REGISTER OC2RS
#define TONERESET_REGISTER OC2R
#define TONECONFIG_REGISTER OC2CON
...
char ToneGeneration_Init(void)
{
    ...
    TONECONFIG_REGISTER = (_OC2CON_ON_MASK | 0b110 << _OC2CON_OCM_POSITION | _OC2CON_OCTSEL_MASK);
